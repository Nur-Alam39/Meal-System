...
<html>
	...
	<body>	
		<div class='container-fluid ' style='margin:0;margin-top:8%;margin-bottom:4%'>
			<h4 class='text-center'>Create New System</h4>
			<div class='' style='margin:0;margin-left:20%;margin-right:20%;margin-top:2%;padding:0;padding:2%;border-radius:10px;box-shadow:0 0 10px #b3b3b3'>
				<form action="database_create.php" method='post' id='create_form'>
				  <div class="form-row">
